...
class GenerateAzurePlatform extends Command {
    async run() {
        console.log('Currently not functional');
    }
}
GenerateAzurePlatform.description = 'Create Azure pipeline and armconfig files from template';
GenerateAzurePlatform.examples = [
    '<%= config.bin %> <%= command.id %>',
];
GenerateAzurePlatform.flags = {
    name: Flags.string({
        char: 'n',
...
GenerateAzurePlatform.args = {};
export default GenerateAzurePlatform;
