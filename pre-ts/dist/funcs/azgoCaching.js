...
import { formatDistance, differenceInHours, parseISO } from 'date-fns';
...
*
*/
export function setCache(cacheFileName, data, subscriptionId, cacheDir = process.env.XDG_CACHE_HOME || global.config.cacheDir) {
...
*
*/
export function getCache(cacheFileName, subscriptionId, cacheDir = process.env.XDG_CACHE_HOME || global.config.cacheDir) {
...
*
*/
export function cacheExists(cacheFileName, subscriptionId, cacheDir = process.env.XDG_CACHE_HOME ) {
...
*
*/
export function initCache(cacheDir, subscriptionId) {
