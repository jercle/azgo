...
export default async function listMyWorkItems({ user = '', organization = '', filterType = null, filterState = null, groupBy = '', all, closed, }) {
    ...
    try {
        if (!pat) {
         ...
         ${chalk.italic(chalk.dim(`Obtain a Personal Access Token from https://dev.azure.com/${organization}/_usersSettings/tokens
