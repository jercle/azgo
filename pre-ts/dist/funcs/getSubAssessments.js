...
export default async function getsubAssessments({ assessmentId, subscriptionId, resourceGroup, acrRegistry, outfile, resyncData }, credentials) {
    // return {data: []}
    ...
    const subAssessmentsList = await client.subAssessments.list(`/subscriptions/${subscriptionId}/resourceGroups/${resourceGroup}/providers/Microsoft.ContainerRegistry/registries/${acrRegistry}`, assessmentId);
    let data = [];
