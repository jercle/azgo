...
export default async function selectActiveSubscription() {
    ...
    const answer = await inquirer.prompt({
        ...
        message: `${chalk.dim(`${chalk.bold('Current active subscription')}
      ID: ${currentActive.id}
    ...
    if (answer.changeActiveSub) {
        ...
        console.log(chalk.green(`Active subscription changed to ${newSubAnswer.subscriptionId.subscriptionId} - ${newSubAnswer.subscriptionId.name} - ${newSubAnswer.subscriptionId.user}`));
...
export async function selectActiveAzureDevOpsSubscription(configLocation) {
